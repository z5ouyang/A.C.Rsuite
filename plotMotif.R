...
if(!suppressWarnings(suppressMessages(require(grImport,quietly=T)))) install.packages("grImport")
if(!suppressWarnings(suppressMessages(require(gridExtra,quietly=T)))) install.packages("gridExtra")
if(!suppressWarnings(suppressMessages(require(pheatmap,quietly=T)))) install.packages("pheatmap")
if(!suppressWarnings(suppressMessages(require(RColorBrewer,quietly=T)))) install.packages("RColorBrewer")
if(!suppressWarnings(suppressMessages(require(colorspace,quietly=T)))) install.packages("colorspace")
if(!suppressWarnings(suppressMessages(require(ggplot2,quietly=T)))) install.packages("ggplot2")
if(!suppressWarnings(suppressMessages(require(htmltab,quietly = T)))) install.packages("htmltab")
